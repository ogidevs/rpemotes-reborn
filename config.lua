...
Config = {
    ...
    IdleAnimationTimer = 25000, -- Time in milliseconds until the idle animation plays
    ResetIdleOnMovement = true, -- If true, the idle animation timer resets when the player moves
    IdleAnimationsList = {
        "crossarms3",
        "shakeoff",
        "think5",
