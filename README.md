...
This is a heavily edited version of **rpemotes-reborn**, featuring:

- **Idle Animations**: Seamlessly integrated to enhance immersion.
- **Completely Redesigned UI**: A modern, user-friendly interface.
- **Animation Previews**: Preview every animation directly in the menu.
- **Tweaks and Improvements**: Optimized performance and additional features.

All of this is provided **free of charge**, with full credit to the original authors of rpemotes-reborn. We are committed to maintaining the spirit of open-source collaboration and community-driven development.

Enjoy the enhanced experience with NewEra Scripts!

New changes made in October 2025.
